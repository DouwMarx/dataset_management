...
image_dir = pathlib.Path(
    "/home/douwm/projects/PhD/resources/images_and_descriptions/images/plots/signal_processing_jacobian"
)
...
for vehicle in ["Mondeo", "Vectra"]:
    ...
    for mode_name, mode_data, mode_color in zip(
        ["Whistle fault", "Normal"],
        [whistle_meta_data, normal_meta_data],
        ["red", "green"],
    ):
