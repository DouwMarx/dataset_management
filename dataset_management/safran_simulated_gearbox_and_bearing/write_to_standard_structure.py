...
healthy_data = "/home/douwm/data/safran_simulated_gearbox_and_bearing/data/simple_healty_dataset.mat"
...
export_data_to_file_structure("safran_simple",x0,{"faulty":x}, export_path=biased_anomaly_detection_path,metadata=metadata)
