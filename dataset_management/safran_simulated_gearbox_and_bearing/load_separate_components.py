...
for difficulty_level in ["simple", "moderate", "extreme"]:
    healthy_component_path = (
        "/home/douwm/data/safran_simulated_gearbox_and_bearing/components/"
        + difficulty_level
        + "_healthy_dataset.mat"
    )
    faulty_component_path = (
        "/home/douwm/data/safran_simulated_gearbox_and_bearing/components/"
        + difficulty_level
        + "_faulty_dataset.mat"
    )
    ...
    n_samples_required_to_capture_fault_events = (
        n_faut_events_per_segement * healthy_data["Event"][0, 0]
    )
    ...
    metadata = {
        ...
        "n_samples_required_to_capture_fault_events": int(
            n_samples_required_to_capture_fault_events
        ),
