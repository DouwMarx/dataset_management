...
from dataset_management.general.update_database_with_processed import (
    compute_features_from_time_series_doc,
)
from dataset_management.utils.update_database import new_derived_doc
...
from dataset_management.utils import update_database

o = update_database.DerivedDoc(
    query, "raw", "processed", compute_features_from_time_series_doc
)
